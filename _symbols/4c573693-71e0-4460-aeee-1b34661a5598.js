// Hero with form - Updated September 26, 2023
function noop() { }
const identity = x => x;
...
function create_if_block_5(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "message error svelte-1ul81oz");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "message svelte-1ul81oz");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(input, "class", "svelte-1ul81oz");
			attr(label, "class", "svelte-1ul81oz");
			attr(button, "class", "button svelte-1ul81oz");
			attr(button, "type", "submit");
			attr(form_1, "class", "svelte-1ul81oz");
		},
		m(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "graphic left svelte-1ul81oz");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "graphic right svelte-1ul81oz");
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t0 = claim_text(h10_nodes, /*heading*/ ctx[1]);
			h10_nodes.forEach(detach);
			t1 = claim_space(section_nodes);
			h11 = claim_element(section_nodes, "H1", { class: true });
			var h11_nodes = children(h11);
			t2 = claim_text(h11_nodes, /*heading2*/ ctx[3]);
		...
		h() {
			attr(h10, "class", "headline svelte-1ul81oz");
			attr(h11, "class", "headline2 svelte-1ul81oz");
			attr(section, "class", "section-container svelte-1ul81oz");
		},
		m(target, anchor) {
			insert_hydration(target, section, anchor);
			append_hydration(section, h10);
			append_hydration(h10, t0);
			append_hydration(section, t1);
			append_hydration(section, h11);
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*heading2*/ 8) set_data(t2, /*heading2*/ ctx[3]);
			let previous_block_index = current_block_type_index;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('heading2' in $$props) $$invalidate(3, heading2 = $$props.heading2);
	};
