// Site Footer - Updated September 26, 2023
function noop() { }
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t4 = claim_text(span1_nodes, "Créé par ");
			a = claim_element(span1_nodes, "A", { href: true, class: true });
			var a_nodes = children(a);
			t5 = claim_text(a_nodes, "France Angels");
			a_nodes.forEach(detach);
		...
		h() {
			...
			attr(a, "href", "https://franceangels.org");
			attr(a, "class", "svelte-1excgdw");
